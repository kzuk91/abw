...
public class InstalmentPlan_ {
    ...
    private EarliestDueDateInstalment_ earliestDueDateInstalment;
    /**
     * 
     * (Required)
     * 
    ...
    private List<PaidInstalment_> paidInstalments = new ArrayList<PaidInstalment_>();
    /**
     * 
     * (Required)
     * 
    ...
    private List<UnpaidInstalment_> unpaidInstalments = new ArrayList<UnpaidInstalment_>();
    @JsonIgnore
     ...
     */
    @JsonProperty("earliestDueDateInstalment")
    public EarliestDueDateInstalment_ getEarliestDueDateInstalment() {
     ...
     */
    @JsonProperty("earliestDueDateInstalment")
    public void setEarliestDueDateInstalment(EarliestDueDateInstalment_ earliestDueDateInstalment) {
     ...
     */
    @JsonProperty("paidInstalments")
    public List<PaidInstalment_> getPaidInstalments() {
     ...
     */
    @JsonProperty("paidInstalments")
    public void setPaidInstalments(List<PaidInstalment_> paidInstalments) {
     ...
     */
    @JsonProperty("unpaidInstalments")
    public List<UnpaidInstalment_> getUnpaidInstalments() {
     ...
     */
    @JsonProperty("unpaidInstalments")
    public void setUnpaidInstalments(List<UnpaidInstalment_> unpaidInstalments) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof InstalmentPlan_) == false) {
            return false;
        }
        InstalmentPlan_ rhs = ((InstalmentPlan_) other);
