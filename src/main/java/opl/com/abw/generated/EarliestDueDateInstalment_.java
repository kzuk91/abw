...
public class EarliestDueDateInstalment_ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EarliestDueDateInstalment_) == false) {
            return false;
        }
        EarliestDueDateInstalment_ rhs = ((EarliestDueDateInstalment_) other);
