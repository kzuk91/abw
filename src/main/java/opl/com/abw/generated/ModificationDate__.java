...
public class ModificationDate__ {
    ...
    private Chronology___ chronology;
    /**
     * 
     * (Required)
     * 
     ...
     */
    @JsonProperty("chronology")
    public Chronology___ getChronology() {
        return chronology;
    }
     ...
     */
    @JsonProperty("chronology")
    public void setChronology(Chronology___ chronology) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ModificationDate__) == false) {
            return false;
        }
        ModificationDate__ rhs = ((ModificationDate__) other);
