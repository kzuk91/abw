...
public class EarliestDueDateInstalment {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EarliestDueDateInstalment) == false) {
            return false;
        }
        EarliestDueDateInstalment rhs = ((EarliestDueDateInstalment) other);
