...
public class GetRoamingExceededRequest {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetRoamingExceededRequest) == false) {
            return false;
        }
        GetRoamingExceededRequest rhs = ((GetRoamingExceededRequest) other);
