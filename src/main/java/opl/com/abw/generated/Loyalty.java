...
public class Loyalty {
    ...
    private List<Device__> devices = new ArrayList<Device__>();
    /**
     * 
     * (Required)
     * 
    ...
    private ModificationDate__ modificationDate;
    /**
     * 
     * (Required)
     * 
     ...
     */
    @JsonProperty("modificationDate")
    public ModificationDate__ getModificationDate() {
     ...
     */
    @JsonProperty("modificationDate")
    public void setModificationDate(ModificationDate__ modificationDate) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Loyalty) == false) {
            return false;
        }
        Loyalty rhs = ((Loyalty) other);
