...
public class InstalmentPlan {
    ...
    private EarliestDueDateInstalment earliestDueDateInstalment;
    /**
     * 
     * (Required)
     * 
    ...
    private List<PaidInstalment> paidInstalments = new ArrayList<PaidInstalment>();
    /**
     * 
     * (Required)
     * 
    ...
    private List<UnpaidInstalment> unpaidInstalments = new ArrayList<UnpaidInstalment>();
    @JsonIgnore
     ...
     */
    @JsonProperty("earliestDueDateInstalment")
    public EarliestDueDateInstalment getEarliestDueDateInstalment() {
     ...
     */
    @JsonProperty("earliestDueDateInstalment")
    public void setEarliestDueDateInstalment(EarliestDueDateInstalment earliestDueDateInstalment) {
     ...
     */
    @JsonProperty("paidInstalments")
    public List<PaidInstalment> getPaidInstalments() {
     ...
     */
    @JsonProperty("paidInstalments")
    public void setPaidInstalments(List<PaidInstalment> paidInstalments) {
     ...
     */
    @JsonProperty("unpaidInstalments")
    public List<UnpaidInstalment> getUnpaidInstalments() {
     ...
     */
    @JsonProperty("unpaidInstalments")
    public void setUnpaidInstalments(List<UnpaidInstalment> unpaidInstalments) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof InstalmentPlan) == false) {
            return false;
        }
        InstalmentPlan rhs = ((InstalmentPlan) other);
