...
public class ModificationDate {
    ...
    private Chronology_ chronology;
    /**
     * 
     * (Required)
     * 
     ...
     */
    @JsonProperty("chronology")
    public Chronology_ getChronology() {
        return chronology;
    }
     ...
     */
    @JsonProperty("chronology")
    public void setChronology(Chronology_ chronology) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ModificationDate) == false) {
            return false;
        }
        ModificationDate rhs = ((ModificationDate) other);
