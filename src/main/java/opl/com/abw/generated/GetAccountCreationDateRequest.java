...
public class GetAccountCreationDateRequest {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetAccountCreationDateRequest) == false) {
            return false;
        }
        GetAccountCreationDateRequest rhs = ((GetAccountCreationDateRequest) other);
