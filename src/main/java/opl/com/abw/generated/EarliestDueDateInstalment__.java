...
public class EarliestDueDateInstalment__ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EarliestDueDateInstalment__) == false) {
            return false;
        }
        EarliestDueDateInstalment__ rhs = ((EarliestDueDateInstalment__) other);
