...
public class RetentionStartDate {
    ...
    private Chronology____ chronology;
    /**
     * 
     * (Required)
     * 
     ...
     */
    @JsonProperty("chronology")
    public Chronology____ getChronology() {
        return chronology;
    }
     ...
     */
    @JsonProperty("chronology")
    public void setChronology(Chronology____ chronology) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RetentionStartDate) == false) {
            return false;
        }
        RetentionStartDate rhs = ((RetentionStartDate) other);
