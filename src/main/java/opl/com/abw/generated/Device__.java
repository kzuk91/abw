...
public class Device__ {
    ...
    private InstalmentPlan__ instalmentPlan;
    /**
     * 
     * (Required)
     * 
     ...
     */
    @JsonProperty("instalmentPlan")
    public InstalmentPlan__ getInstalmentPlan() {
     ...
     */
    @JsonProperty("instalmentPlan")
    public void setInstalmentPlan(InstalmentPlan__ instalmentPlan) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Device__) == false) {
            return false;
        }
        Device__ rhs = ((Device__) other);
