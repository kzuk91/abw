...
public class StatusChangeDateTime {
    ...
    private Chronology_____ chronology;
    /**
     * 
     * (Required)
     * 
     ...
     */
    @JsonProperty("chronology")
    public Chronology_____ getChronology() {
        return chronology;
    }
     ...
     */
    @JsonProperty("chronology")
    public void setChronology(Chronology_____ chronology) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StatusChangeDateTime) == false) {
            return false;
        }
        StatusChangeDateTime rhs = ((StatusChangeDateTime) other);
